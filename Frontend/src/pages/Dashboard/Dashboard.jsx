...
import {
    ...
    TrendingUp, Plus, Search, Edit2, Trash2, X
} from 'lucide-react';
                ...
                < header className="dash-topbar" >
                    <div className="topbar-greeting">
                        <h1>
                            ...
                            {user.role !== 'admin' && <span style={{ color: '#a855f7' }}>{user.role === 'student' ? 'Student' : user.role}</span>}
                        </h1>
                                            ...
                                            <div className="mec-body">
                                                ...
                                                <div className="mec-footer">
                                                    ...
                                                    <div className="mec-actions">
                                                        ...
                                                        <Button variant="ghost" size="sm" onClick={(e) => e.stopPropagation()}><QrCode size={14} /> Ticket</Button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
